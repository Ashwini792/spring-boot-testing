...
public class EmployeeRepositoryITests extends AbstractionBaseTest{
    ...
    @Test
     void givenEmployye_whenFindByEmail_thenReturnEmployee()
    {
        employeeRepository.save(emp);
    ...
    @Test
     void givenEmployeeEmail_whenfindbyemail_thenReturnUpdatedEmployee()
    {
        //given data, setup
        employeeRepository.save(emp);
    ...
    @Test
     void givenEmployee_whenDelete_thenReturn()
    {
        //given data, setup
        employeeRepository.save(emp);
    ...
    @Test
     void givenFirstNameLastName_whenFindBy_thenReturnEmployee()
    {
        //given data, setup
        employeeRepository.save(emp);
